        ...
        <FormControl>
          <VStack w={'100%'} space="4" mt="2" px="4">
            ...
            <Controller name="password" control={control} render={({ field: { onChange, onBlur, value } }) => (
              <Input onBlur={onBlur} value={value} onChange={onChange} placeholder='Password' type={isPasswordVisible ? 'text' : 'password'} rightElement={renderRightInputElement('password')} />
            )} />
