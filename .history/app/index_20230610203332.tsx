import { Button, FormControl, HStack, Input, Stack, Text, VStack, View } from 'native-base';
      ...
      <VStack alignItems={'center'} flex={1} justifyContent='center'>
        ...
        <Stack w="full" px={'6'}>
          <Form control={control}>
            <Form.Input name='email' label='Email' rightElement={renderRightInputElement('email')} />
            <Form.Input name='password' label='Password' rightElement={renderRightInputElement('password')} type={isPasswordVisible ? 'text' : 'password'} />
          </Form>
