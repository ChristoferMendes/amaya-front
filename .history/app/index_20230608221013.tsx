...
export default function Test() {
  ...
  const renderRightInputElement = (inputType: 'email' | 'password') => {
    ...
    return (
      <InputIconContainer>
        <Lock color='#fff' onPress={() => setIsPasswordVisible(!isPasswordVisible)} />
      </InputIconContainer>
    )
  }
    ...
    <>
      <VStack alignItems={'center'} flex={1} justifyContent='center'>
        ...
        <VStack w={'100%'} space="4" mt="2" px="4">
          ...
          <Input placeholder='Password' type={isPasswordVisible ? 'text' : 'password'} secureTextEntry={isPasswordVisible rightElement={renderRightInputElement('password')} />
